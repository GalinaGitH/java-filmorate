...
public class SlopeOne {
    ...
    private HashMap<Long, Double> predictInt(Long user) {
        ...
        Optional<Map.Entry<Long, HashMap<Long, Double>>> entry = inputDataInt.entrySet().stream().
    ...
    private List<Long> getAllUsersItems(Map<Long, HashMap<Long, Double>> input, Long userId) {
    ...
    private List<Long> getAllItemsExceptInputUsers(Map<Long, HashMap<Long, Double>> input) {
